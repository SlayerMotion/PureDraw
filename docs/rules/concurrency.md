...
Concurrency posture for PureDraw and PureDraw: immutability first, sparse actors, escape hatches always justified, grounded in the Swift Evolution proposals.
