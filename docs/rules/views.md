...
SwiftUI view rules for the planned PureDraw native editor: purely presentational, performant, accessible, reusable. Views observe ViewModels but contain ZERO business logic.
